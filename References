...
- Fama, E. F., & French, K. R. (2020). "The Value Premium." *Fama-Miller Working Paper*, University of Chicago Booth School of Business.
...
- Asness, C. S., Porter, R. B., & Stevens, R. L. (2000). "Predicting Stock Returns Using Industry-Relative Firm Characteristics." *Working Paper, AQR Capital Management*.
- Jensen, T. I., Kelly, B. T., & Pedersen, L. H. (2023). "Is There a Replication Crisis in Finance?" *Journal of Finance*, 78(5), 2465-2518.

## Intangible Capital — Core Innovation
...
- Eisfeldt, A. L., Kim, E., & Papanikolaou, D. (2022). "Intangible Value." *Critical Finance Review*, 11(2), 299-342.
...
- Novy-Marx, R., & Velikov, M. (2022). "Comparing Cost Mitigation Techniques." *Financial Analysts Journal*, 78(1), 54-75.
...
- WRDS / CRSP: Center for Research in Security Prices
- WRDS / Compustat: Standard & Poor's Compustat Database
